...
echo. >> "%STAGE_DIR%\README.txt"
echo EXAMPLES: >> "%STAGE_DIR%\README.txt"
echo   bat\run_ollama_llava.bat >> "%STAGE_DIR%\README.txt"
echo   bat\run_claude_opus4.bat >> "%STAGE_DIR%\README.txt"
echo. >> "%STAGE_DIR%\README.txt"
echo For full documentation, see QUICK_START.md and docs\ folder >> "%STAGE_DIR%\README.txt"
