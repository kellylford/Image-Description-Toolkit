Follow these guidelines for all coding.
...
6. Keep a running log of chat conversations in ~/your_secure_location/VSCodeAIChat.md. Be aware other machines may also edit the file.