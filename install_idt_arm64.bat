@echo off
REM ============================================================================
REM Install Image Description Toolkit - ARM64 Architecture
REM ============================================================================
...
REM     * viewer_v*_arm64.zip (viewer GUI)
REM     * prompt_editor_v*_arm64.zip (prompt editor GUI)
REM     * imagedescriber_v*_arm64.zip (image describer GUI)
...
echo.
echo ========================================================================
echo IMAGE DESCRIPTION TOOLKIT - INSTALLER (ARM64)
echo ========================================================================
echo.
