...
def main():
    ...
    if '--list-providers' in sys.argv:
        ...
        print()
        print("huggingface  - HuggingFace local vision-language models")
        print("             Models: Qwen2-VL, LLaVA-OneVision, etc.")
        print("             Requires: transformers, torch, pillow (runs locally)")
        print()
        print("=" * 60)
        sys.exit(0)
