...
REM ============================================================================
REM This script creates separate virtual environments for all four applications
...
REM   5. Installs requirements.txt in each venv
REM
REM Prerequisites:
...
echo.
echo [4/4] Setting up ImageDescriber...
echo ========================================================================
echo.
